...
static unsigned int gpioButton = 60;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
...
static int __init ebbgpio_init(void){
   ...
   ledOn = true;
   gpio_request(gpioLED, "sysfs");          // gpioLED is hardcoded to 51, request it
